...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AfterSchoolReduplicationException.class)
    public ResponseEntity<ErrorResponse> AfterSchoolReduplicationExceptionHandler(HttpServletRequest request, AfterSchoolReduplicationException ex) {
        printException(request, ex, "AfterSchool is Reduplication");
        ErrorResponse errorResponse = new ErrorResponse(ex.getErrorCode());
        return new ResponseEntity<>(errorResponse, HttpStatus.valueOf(ex.getErrorCode().getStatus()));
    }
